#!/usr/bin/env python
# coding: utf-8
# python pixelization.py <h5_path> <output_path> <resolution>
# python pixelization.py python pixelization.py ./HVmodel/data/jet_rotation/sig_in_SR.h5 ./HVmodel/data/jet_rotation/25x25/sig_in_SR.npy 25
...
def from_h5_to_npy(h5_path, output_path, res=75):
    ...
    with h5py.File(h5_path, 'r') as f:
        ...
        hpT0 = pixelization(f['J1/pt'][:], f['J1/eta'][:], f['J1/phi'][:], res)
        hpT1 = pixelization(f['J2/pt'][:], f['J2/eta'][:], f['J2/phi'][:], res)
