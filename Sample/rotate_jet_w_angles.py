#!/usr/bin/env python
# coding: utf-8
# python rotate_jet_w_angles.py <h5_path> <output_path> <angles> <resolution> 
# python rotate_jet_w_angles.py ./HVmodel/data/split_val/mix_sample_0.0.h5 ./HVmodel/data/rotate_jet/mix_sample_0.0_jet_aug_1_75x75.h5 -5_5_-1_1 75
...
def rotate_jet_augmentation_w_angles(h5_path, output_path, angles, res=75):
    # after pre-process, rotate the jet image with specific angle
...
def main():
    ...
    angles = [np.pi / 180 * int(angle) for angle in sys.argv[3].split('_')]
    res = int(sys.argv[4])

    rotate_jet_augmentation_w_angles(h5_path, output_path, angles, res)
