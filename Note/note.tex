...
\label{sec:cwola_hunting}
	...
	\label{sub:enlarge_the_signal_sample_size}
		...
		Additional samples within this size range are generated to further understand the behavior between 10 times and 100 times samples for the $\text{500 GeV}$ case, and the DNN is trained on these samples.
...
\label{sec:hidden_valley_model}
	...
	\label{sub:another_testing_dataset}
		...
		\begin{figure}[htpb]
			...
			\caption{The accuracy curves of two different testing sets. We present the ACC of the best training model. In all cases, they have similar performance.}
