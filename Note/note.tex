...
\label{sec:cwola_hunting}
	...
	\label{sub:pt_cut_testing}
		...
		\begin{figure}[htpb]
			\centering
			\includegraphics[width=0.5\textwidth]{m4j_distribution_background_various_pt_cut.png}
...
\label{sec:hidden_valley_model}
	...
	\label{sub:sample_generation}
		...
		The background sample is the SM di-jet sample. This process is generated at $\sqrt{s} = \text{13 TeV}$. Following are the \verb|MadGraph| scripts for generating background samples:	
		\begin{verbatim}
			generate p p > j j
			output ppjj
			launch ppjj
	...
	\label{sub:sample_selection}
		...
		\begin{table}[htpb]
			...
			$p_{\text{T}}$ cut & 9890   & 0.99      & 57832      & 0.58      \\
			$\eta$ cut         & 8975   & 0.90      & 55523      & 0.56      \\ \hline
		...
		\begin{figure}[htpb]
			\centering
			\subfloat[Signal]{
				\includegraphics[width=0.45\textwidth]{HVmodel_pt_distribution-sig.png}
			}
			\subfloat[Background]{
				\includegraphics[width=0.45\textwidth]{HVmodel_pt_distribution-bkg.png}
			}
		...
		\begin{figure}[htpb]
			...
			\subfloat[My plot]{
				\includegraphics[width=0.45\textwidth]{HVmodel_mjj_distribution.png}
			}
			\subfloat[Zong-En's plot]{
				\includegraphics[width=0.50\textwidth]{HVmodel_mjj_distribution-Zong-En.png}
			}
			\caption{The totoal invriant mass $m_{jj}$ distribution of signal and background samples. In my plot, the signal region is between the red dashed lines. The sideband region is between the green dashed lines and excludes the signal region.}
