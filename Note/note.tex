...
\label{sec:hidden_valley_model}
    ...
    \label{sub:jet_image_normalization}
        ...
        \subsection{\texorpdfstring{$p_{\mathrm{T}}$}{pT} normalization 2}% (fold)
        \label{sub:pt_normalization_2}
            ...
            Another test is exchanging our dataset pool. I randomly sample the events from Zong-En's pool and prepare my testing set for training. Figure~\ref{fig:sensitivity_improvement_image_pt_normalized_origin_FY_ZN_pool} is the sensitivity improvement for different training pools. Our training results are consistent when using the original method to compute the sensitivity improvement. However, when I applied the background subtraction method, the results were unusual. The code for background subtraction should be rechecked.
            \begin{figure}[htpb]
                \centering
            ...
            \end{figure}
        % subsection pt_normalization_2 (end)
