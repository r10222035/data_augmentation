...
\label{sec:hidden_valley_model}
	...
	\label{sub:check_the_codes_and_make_more_plots}
		...
		\begin{figure}[htpb]
			...
			\caption{The pseudorapidity distribution before and after the $\eta-\phi$ smearing augmentation. $\eta_1$ and $\eta_2$ are the pseudorapidities of the leading and the sub-leading jet constituents, respectively.}
		...
		\begin{figure}[htpb]
			...
			\caption{The azimuthal angle distribution before and after the $\eta-\phi$ smearing augmentation. $\phi_1$ and $\phi_2$ are the azimuthal angles of the leading and the sub-leading jet constituents, respectively.}
		...
		\begin{figure}[htpb]
			...
			\caption{The average jet images of different cases.}
