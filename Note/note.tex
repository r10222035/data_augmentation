...
\label{sec:hidden_valley_model}
    ...
    \label{sub:data_augmentation_with_image_normalization}
        ...
        \begin{figure}[htpb]
            ...
            \caption{The sensitivities after the CWoLa CNN selection. Here, $3.0$ is the sensitivity before selection. The dashed line is the sensitivity before CNN selection. The error bar is the standard deviation of 3 times training. We use different datasets for each training.}
