...
\label{sec:hidden_valley_model}
    ...
    \label{sub:sculpting_effect_2}
        ...
        \begin{table}[htpb]
			...
			\multirow{3}{*}{+3 $p_{\text{T}}$-jet} & 10.0 \%                & 12.4 \%                & 13.9     & 10.0 \%                & 12.4 \%                & 6.5      \\
												   & 1.00 \%                & 2.02 \%                & 15.4     & 1.00 \%                & 2.02 \%                & 8.7      \\
												   & 0.10 \%                & 0.23 \%                & 4.4      & 0.10 \%                & 0.23 \%                & 0.4     
			\end{tabular}
		\end{table}
