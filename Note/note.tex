	...
	\label{sub:other_plots}
		...
		\label{subs:signal_score}
			...
			\begin{figure}[htpb]
				...
				\caption{The signal score distribution of the model trained on original and duplicated datasets. The sensitivity $S / \sqrt{B} = 3$. The signal score is evaluated from the best model. The input events are the signal and background events in signal region.}
