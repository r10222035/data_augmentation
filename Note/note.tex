...
\label{sec:hidden_valley_model}
	...
	\label{sub:compare_with_zong_en_s_results}
		...
		Since my training results are inconsistent with Zong-En's, it is need to make a comparison with Zong-En's training codes. The main differences are listed below:
		\begin{enumerate}
		...
		\label{subs:tensorflow_version}
			...
			I should test my training codes on version 2.0.0, but there is an error that still can not be resolved for now.
